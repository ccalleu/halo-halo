...
public class CallLogAdapter extends GroupingListAdapter
    ...
    public String getCallRemoteAtPostion(int position) {
        ...
        if(item != null) {
            ...
            String numberSipUri = SipUri.getCanonicalSipContact(number, false); //zmiana
            String[] numberNoSipUri = numberSipUri.split("@"); //dodane
            return numberNoSipUri[0]; //zwracało SipUri.getCanonicalSipContact(number, false);
        }
        return "";
    }
