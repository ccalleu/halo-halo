...
public class halohalo extends SimpleImplementation {
	
	@Override
	protected String getDomain() {
		return "node5.c-call.eu:11834";
	}
	...
	public void fillLayout(final SipProfile account) {
		...
		accountUsername.setTitle("Numer karty");
	}
	...
	public void setDefaultParams(PreferencesWrapper prefs) {
        ...
        // uzywaj uparcie na WideBand ULAWa i ALAWa, ewentualnie GSM
        ...
        //na NarrowBand uzywaj tego samego, olewamy transfer na razie
        prefs.setCodecPriority("PCMU/8000/1", SipConfigManager.CODEC_NB,"241");
        ...
        prefs.setCodecPriority("GSM/8000/1", SipConfigManager.CODEC_NB, "239");
