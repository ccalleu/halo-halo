...
import com.csipsimple.wizards.impl.halohalo;
...
public final class CustomDistribution {
	...
	public static WizardInfo getCustomDistributionWizard() {
		return new WizardInfo("HALOHALO", "halohalo", 
                R.drawable.halohalo_ico, 19, 
                new Locale[]{ new Locale("en") }, false, false, 
                halohalo.class); 
	}
